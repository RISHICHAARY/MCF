...
function Upload_User(){
    ...
    const resend = () =>{
        setResend(false);
        Axios.post("https://busy-lion-umbrella.cyclic.app/adminMailer" , {
    ...
    const Upload = () => {
        ...
        uploadBytes(FileReference , Location.state.file).then((FileData) => {
            getDownloadURL(FileData.ref).then((url) => {
                Axios.put("https://busy-lion-umbrella.cyclic.app/addAdmin" , 
                {
                    image_url : url,
                    name : Location.state.name,
                    ...
                    Axios.put("https://busy-lion-umbrella.cyclic.app/Admin",{email:Location.state.email}).then((result)=>{
                        setLoading(false);
