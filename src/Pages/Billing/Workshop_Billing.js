...
function Confirmation(){
        ...
        if(PaymentMode === "PN"){
            var options = {
                ...
                handler: function(response){
                    setLoading(true);
                    Axios.put("https://busy-lion-umbrella.cyclic.app/addEnrollment" , { wg : WG , wn : WN, type : Location.type , id :Id , name : Name , mobile : Mobile , email : Email , total : Total }).then(
                    ()=>{
                        setLoading(false);
    ...
    useEffect(()=>{
            ...
            Axios.put("https://busy-lion-umbrella.cyclic.app/getCart" , {type : Location.state.type , id:Location.state.id}).then((response)=>{
                ...
                Axios.put("https://busy-lion-umbrella.cyclic.app/getSelectedWorkShops" , {id:Location.state.Product_id}).then((response1) => {
