...
function Filter() {
    ...
    const Search = (event) => {
        ...
        setLoading(true);
        Axios.put("https://busy-lion-umbrella.cyclic.app/getSearch" , {name : SearchThis.toUpperCase()}).then((response)=> {
    ...
    const Search2 = () => {
        setLoading(true);
        Axios.put("https://busy-lion-umbrella.cyclic.app/getSearch" , {name : Location.state.search.toUpperCase()}).then((response)=> {
            setProducts(response.data);
    ...
    const Sort = () => {
        if(SortThis === null){
            setLoading(true);
            Axios.put('https://busy-lion-umbrella.cyclic.app/getProducts' , {Category : Category , Tag : Tag}).then((response) => {
                setProducts(response.data);
                    if(Location.state.user !== undefined){
                        Axios.put("https://busy-lion-umbrella.cyclic.app/getCart" , {type : Location.state.type , id:Location.state.id}).then((response)=>{
                            setCartItems(response.data[0].wishlist);
            ...
            setLoading(true);
            Axios.put('https://busy-lion-umbrella.cyclic.app/getProductsSPA' , {Category : Category , Tag : Tag}).then((response) => {
                setProducts(response.data);
                    if(Location.state.user !== undefined){
                        Axios.put("https://busy-lion-umbrella.cyclic.app/getCart" , {type : Location.state.type , id:Location.state.id}).then((response)=>{
                            setCartItems(response.data[0].wishlist);
            ...
            setLoading(true);
            Axios.put('https://busy-lion-umbrella.cyclic.app/getProductsSPD' , {Category : Category , Tag : Tag}).then((response) => {
                setProducts(response.data);
                    if(Location.state.user !== undefined){
                        Axios.put("https://busy-lion-umbrella.cyclic.app/getCart" , {type : Location.state.type , id:Location.state.id}).then((response)=>{
                            setCartItems(response.data[0].wishlist);
            ...
            setLoading(true);
            Axios.put('https://busy-lion-umbrella.cyclic.app/getProductsSNA' , {Category : Category , Tag : Tag}).then((response) => {
                setProducts(response.data);
                    if(Location.state.user !== undefined){
                        Axios.put("https://busy-lion-umbrella.cyclic.app/getCart" , {type : Location.state.type , id:Location.state.id}).then((response)=>{
                            setCartItems(response.data[0].wishlist);
            ...
            setLoading(true);
            Axios.put('https://busy-lion-umbrella.cyclic.app/getProductsSND' , {Category : Category , Tag : Tag}).then((response) => {
                setProducts(response.data);
                    if(Location.state.user !== undefined){
                        Axios.put("https://busy-lion-umbrella.cyclic.app/getCart" , {type : Location.state.type , id:Location.state.id}).then((response)=>{
                            setCartItems(response.data[0].wishlist);
    ...
    const delete_product = (id) => {
        setLoading(true);
        Axios.put('https://busy-lion-umbrella.cyclic.app/DeleteProduct' , {id : id}).then(() =>{
    ...
    const Filter2 = () => {
        setLoading(true);
        Axios.put('https://busy-lion-umbrella.cyclic.app/getProducts' , {Category : Location.state.Cata , Tag : Tag}).then((response) => {
                            ...
                            <div className='image-div'>
                                ...
                                {(Location.state!== null && Location.state.type === "admin")?
                                    ...
                                    <button className='edit-button' onClick={() => {
                                        Axios.post("https://busy-lion-umbrella.cyclic.app/getProducts",{id : value._id}); 
