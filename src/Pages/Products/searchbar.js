...
function Search() {
    ...
    const Search = () => {
        setLoading(true);
        Axios.put("https://busy-lion-umbrella.cyclic.app/getSearch" , {name : SearchThis}).then((response)=> {
    ...
    useEffect(()=>{
        setLoading(true);
        Axios.get("https://busy-lion-umbrella.cyclic.app/getAllProducts").then((response) => {
            setProducts(response.data);
                            ...
                            <div className='contents-div'>
                                ...
                                <div className='buttons'>
                                    ...
                                    <>
                                        ...
                                        onClick={() =>{
                                            setLoading(true);
                                            Axios.put("https://busy-lion-umbrella.cyclic.app/addToCart" , {type : Location.state.type , id:Location.state.id , user:Location.state.user , product_id:value._id}).then(() =>{
                                                setLoading(false);
