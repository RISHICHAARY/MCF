                    ...
                    <div className="checkout">
                        <div className="checkout-btn">
                            <button type="button" onClick={()=>{
                                Navigate("/CartConfirmation" , {state:{status: Location.state.status, name: Location.state.name , user:Location.state.user , type:Location.state.type , id:Location.state.id}})
                            }}>Checkout</button>
                        </div>
