...
function Products()
{
    ...
    useEffect(
        () =>{
            Axios.get("https://magiccorner-b.onrender.com/allUsers").then(
                (response) => {
                    setExistingUsers(response.data);
                }
            );
            Axios.get("https://magiccorner-b.onrender.com/allAdmins").then(
                (response) => {
                ...
                if(ExistingUsers.length === 0){
                    ...
                    for(var l =0 ; l < ExistingUsers.length ; l++){
                            if(Email.toString() === ExistingUsers[l].email.toString()){
                                Axios.post("https://magiccorner-b.onrender.com/DeleteUser" , {email:Email});
                                generator();
                                Navigate('/adminVerification' , 
                                    {   
                                        state:{name:Name , email:Email , mobile:Mobile , 
