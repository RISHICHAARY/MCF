...
function Confirmation(){
    ...
    useEffect(()=>{
            ...
            Axios.put("https://magiccorner-b.onrender.com/getCart" , {type : Location.state.type , id:Location.state.id}).then((response)=>{
                ...
                Axios.put("https://magiccorner-b.onrender.com/getSelectedWorkShops" , {id:Location.state.Product_id}).then((response1) => {
                ...
                <div className='container terms-conditions'>
                    ...
                    <input type="checkbox" onChange={()=>{setTCConfirmation(true)}} /><p className='check-box-text'>By checking this you agree to our all terms and conditions.</p>
                    {
                        ...
                        <Elements stripe={stripeTestPromise}>
                            <PaymentForm state={{ status : Location.state.status , type : Location.state.type , wn : WN , id : Id , name : Name , mobile : Mobile , email : Email , total : Total }} />
                        </Elements>
                        :
                        <>
