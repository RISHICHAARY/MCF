...
function Search() {
    ...
    const Search = () => {
        setLoading(true);
        Axios.put("https://magiccorner-b.onrender.com/getSearch" , {name : SearchThis}).then((response)=> {
    ...
    useEffect(()=>{
        setLoading(true);
        Axios.get("https://magiccorner-b.onrender.com/getAllProducts").then((response) => {
            setProducts(response.data);
                            ...
                            <div className='contents-div'>
                                ...
                                <div className='buttons'>
                                    ...
                                    <>
                                        ...
                                        onClick={() =>{
                                            setLoading(true);
                                            Axios.put("https://magiccorner-b.onrender.com/addToCart" , {type : Location.state.type , id:Location.state.id , user:Location.state.user , product_id:value._id}).then(() =>{
                                                setLoading(false);
